    ...
    <div className="bg-[#122644] py-20">
        <Container className={'flex flex-col md:items-center gap-10 md:gap-3 lg:gap-10 md:flex-row justify-between text-white'}>
            ...
            >
                ...
                <a href={judgingImg} target="_blank" rel="noopener noreferrer" className='  mt-5 md:mt-10 px-6 py-2 lg:py-3 bg-[#FC711B] rounded-3xl text-xs font-medium text-white inline-block'>
            ...
            <div 
                ...
                data-aos-duration='800'
            >
                <img src={judgingImg} alt="judge" className="w-full object-cover rounded-sm"/>
            </div>
        </Container>
    </div>
  )
