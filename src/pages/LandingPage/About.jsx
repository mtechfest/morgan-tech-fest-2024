...
const About = () => {
  ...
  At <span className="text-orange-400 font-semibold">Morgan TechFest</span>, we are dedicated to empowering the next generation of technology leaders. Through our annual in-person conference, Innovation Expo, expert-led panels, keynote speakers, hands-on workshops, competitive awards, and strategic networking opportunities, we enable students to discover transformative technologies and evolving career pathways, network with industry and academic leaders, and innovate through impactful research and project showcases.
</p>
