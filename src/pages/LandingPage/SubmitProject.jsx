...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-white/5 border border-white/10 rounded-xl p-5 hover:border-[#FC711B]/40 transition-all duration-300">
        ...
        <Container className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16 text-white">
          ...
          <div className="lg:w-[50%]">
            <div className="relative group">
              {/* OPTIMIZATION: Reduced blur from blur-2xl to blur-lg */}
              <div className="absolute -inset-4 bg-gradient-to-r from-[#FC711B] to-[#ff8c42] rounded-3xl blur-lg opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
              ...
              <div className="absolute -top-6 -right-6 bg-white/10 rounded-2xl p-4 border border-white/20 shadow-2xl">
