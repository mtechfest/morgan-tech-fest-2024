        ...
        <Container className={'flex flex-col lg:flex-row lg:items-center gap-10 text-white'}>
            ...
            > 
                ...
                <div className="flex gap-3 items-center mt-4">
                    ...
                    <a href={'https://form.jotform.com/233056575770057'} target="_blank" rel="noopener noreferrer" className='py-2 px-7 border border-white rounded-3xl text-xs whitespace-nowrap'>Interest Form</a>
                </div>
            </div>
            <div 
