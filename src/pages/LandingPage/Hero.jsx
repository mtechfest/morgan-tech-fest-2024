...
const Hero = () => {
  return (
    <Container className="flex items-center pt-40 lg:pt-28 xl:pt-32 2xl:pt-40 text-white">
      ...
      <div className="md:w-[73%] xl:w-[65%] 2xl:w-[52%] items-start">
        ...
        <div className="flex justify-between items-end pt-12">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-semibold text-lg md:text-2xl">Morgan State University | Graves School Of<br/> Business and Management</p>
