...
const LandingPage = () => {
  ...
  const teamData = [
    ...
    { name: 'Obi', position: 'Program Manager', image: "https://res.cloudinary.com/YOUR_CLOUD_NAME/image/upload/v1234567890/passport.jpg" },
    ...
    { name: 'Opeyemi Adeniran', position: 'Director', image: "https://drive.google.com/uc?export=view&id=1YXmI0rT0Z2x-XTUc1HRz5G-4xCxLCkWK" },
  ];
